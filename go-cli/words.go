...
func registerSDKWords(r *eng.Registry, client *sdk.GutendexSDK) {
...
func runOp(client *sdk.GutendexSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
