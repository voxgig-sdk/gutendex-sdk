...
function envOverride(m) {
    if ('TRUE' === process.env.GUTENDEX_TEST_LIVE ||
        'TRUE' === process.env.GUTENDEX_TEST_OVERRIDE) {
    ...
    m.GUTENDEX_TEST_EXPLAIN = process.env.GUTENDEX_TEST_EXPLAIN || m.GUTENDEX_TEST_EXPLAIN;
    return m;
}
