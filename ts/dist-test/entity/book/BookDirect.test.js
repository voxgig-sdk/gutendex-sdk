...
(0, node_test_1.describe)('BookDirect', async () => {
    ...
    (0, node_test_1.afterEach)((0, utility_1.liveDelay)('GUTENDEX_TEST_LIVE'));
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.GutendexSDK({
...
function liveScenariosActive() { return false && process.env.GUTENDEX_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.GutendexSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['GUTENDEX_TEST_BOOK_ENTID'];
    ...
    const client = new __1.GutendexSDK({
        base: 'http://localhost:8080',
