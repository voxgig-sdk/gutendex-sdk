...
| `tester(testopts?, sdkopts?)` | `GutendexSDK` | Create a test-mode client instance. |

#### Static methods

| Method | Returns | Description |
| --- | --- | --- |
| `GutendexSDK.test(testopts?, sdkopts?)` | `GutendexSDK` | Create a test-mode client. |
...
| `client` | `client(): GutendexSDK` | Return the parent SDK client. |
