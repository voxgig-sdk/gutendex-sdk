# Gutendex TypeScript SDK Reference

Complete API reference for the Gutendex TypeScript SDK.
...
```ts
new GutendexSDK(options?: object)
```
...
#### `GutendexSDK.test(testopts?, sdkopts?)`
...
**Returns:** `GutendexSDK` instance in test mode.
...
Return the parent `GutendexSDK` instance.
