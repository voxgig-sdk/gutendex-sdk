...
exports.GutendexEntityBase = void 0;
const node_util_1 = require("node:util");
// TODO: needs Entity superclass
// `D` is the entity's typed data model (e.g. Advice); subclasses bind it via
// `class AdviceEntity extends GutendexEntityBase<Advice>`.
class GutendexEntityBase {
    name = '';
    name_ = '';
    Name = '';
    _client;
...
exports.GutendexEntityBase = GutendexEntityBase;
//# sourceMappingURL=GutendexEntityBase.js.map