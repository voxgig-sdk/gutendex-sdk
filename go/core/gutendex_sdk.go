...
func (sdk *GutendexSDK) OptionsMap() map[string]any {
...
func (sdk *GutendexSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *GutendexSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *GutendexSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *GutendexSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *GutendexSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *GutendexSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("GutendexSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *GutendexSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *GutendexSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("GutendexSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
