# Gutendex Golang SDK Reference

Complete API reference for the Gutendex Golang SDK.
...
#### `TestSDK(testopts, sdkopts map[string]any) *GutendexSDK`
...
#### `Book(data map[string]any) GutendexEntity`
