...
func NewBookEntity(client *core.GutendexSDK, entopts map[string]any) *BookEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *BookEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *BookEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *BookEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
