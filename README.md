...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/gutendex` | `npm install @voxgig-sdk/gutendex` |
| Python | `voxgig-sdk-gutendex` | `pip install voxgig-sdk-gutendex` |
| PHP | `voxgig-sdk/gutendex` | `composer require voxgig-sdk/gutendex` |
| Golang | `github.com/voxgig-sdk/gutendex-sdk/go` | `go get github.com/voxgig-sdk/gutendex-sdk/go` |
| Ruby | `voxgig-sdk-gutendex` | `gem install voxgig-sdk-gutendex` |
| Lua | `voxgig-sdk-gutendex` | `luarocks install voxgig-sdk-gutendex` |
