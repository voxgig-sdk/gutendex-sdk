...
Learn more about Gutendex at [gutendex.com](https://gutendex.com).

This is an unofficial SDK for the Gutendex public API, generated by Voxgig with [`@voxgig/sdkgen`](https://github.com/voxgig/sdkgen). It is not affiliated with, endorsed by, or sponsored by the upstream API provider.
...
This SDK exposes the API as a small set of **semantic entities** — Book — that you
...
// books is an array of Book entities, populated with mock data
// — call books[0].data() for the record itself
console.log(books)
```
...
| Ruby | `voxgig-sdk-gutendex` | publish pending — [install from git tag](https://github.com/voxgig-sdk/gutendex-sdk/releases) |
| Lua | `voxgig-sdk-gutendex` | publish pending — [install from git tag](https://github.com/voxgig-sdk/gutendex-sdk/releases) |
| Go CLI | `github.com/voxgig-sdk/gutendex-sdk/go-cli` | `go install github.com/voxgig-sdk/gutendex-sdk/go-cli/cmd/gutendex@latest` |
| Go MCP server | `github.com/voxgig-sdk/gutendex-sdk/go-mcp` | `go get github.com/voxgig-sdk/gutendex-sdk/go-mcp@latest` |
...
| --- | --- | --- |
| **Book** | The Book entity (list, load). | `/books` |
...
- Upstream API: [https://github.com/garethbjohnson/gutendex](https://github.com/garethbjohnson/gutendex)
