...
type Args struct {
	Entity string         `json:"entity" jsonschema:"book"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.GutendexSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "gutendex_list",
		Description: "List records from Gutendex. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "gutendex_load",
		Description: "Load a single record from Gutendex. " +
...
func runOp(client *sdk.GutendexSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.GutendexSDK, name string) (sdk.GutendexEntity, error) {
