...
The Python SDK for the Gutendex API — an entity-oriented client following Pythonic conventions.
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/gutendex-sdk/releases)) or
...
```
py/
├── gutendex_sdk.py         -- Main SDK module
