...
from gutendex_sdk.utility import register

# Load features
from gutendex_sdk.feature.base_feature import GutendexBaseFeature
from gutendex_sdk.features import _has_feature, _make_feature
...
class GutendexSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = GutendexUtility()
        self._utility = utility

        from gutendex_sdk.config import shared_config
    ...
    def get_utility(self):
        return GutendexUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("GutendexSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Book(self, data=None) -> "BookEntity":
        ...
        from gutendex_sdk.entity.book_entity import BookEntity
