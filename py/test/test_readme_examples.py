# Gutendex SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions GutendexSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both GutendexSDK(...) and GutendexSDK.test(...) become
#      GutendexSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "gutendex_sdk"
_SDK_CLASS = "GutendexSDK"
