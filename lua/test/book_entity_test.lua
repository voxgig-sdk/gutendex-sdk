...
describe("BookEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set GUTENDEX_TEST_BOOK_ENTID JSON to run live")
      return
    end
...
function book_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("GUTENDEX_TEST_BOOK_ENTID")
  ...
  if env["GUTENDEX_TEST_LIVE"] == "TRUE" then
