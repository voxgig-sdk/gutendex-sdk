...
The Lua SDK for the Gutendex API — an entity-oriented client using Lua conventions.
...
GitHub release tag (`lua/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/gutendex-sdk/releases)),
...
```
lua/
├── gutendex_sdk.lua    -- Main SDK module
...
The main module (`gutendex_sdk`) exports the SDK constructor
