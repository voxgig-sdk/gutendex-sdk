...
local GutendexSDK = {}
GutendexSDK.__index = GutendexSDK
...
GutendexSDK._make_feature = _make_feature


function GutendexSDK.new(options)
  local self = setmetatable({}, GutendexSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function GutendexSDK:options_map()
...
function GutendexSDK:get_utility()
  return Utility.copy(self._utility)
end


function GutendexSDK:get_root_ctx()
  return self._rootctx
end


function GutendexSDK:prepare(fetchargs)
...
function GutendexSDK:direct(fetchargs)
...
-- by passing it.
function GutendexSDK:_raw_request(fetchargs)
  local utility = self._utility
...
function GutendexSDK:graphql(query, variables, ctrl)
  ...
  if type(errors) == "table" and 0 < #errors then
    ...
    res.ok = false
    res.err = "GutendexSDK: graphql: " .. msg
    res.graphql = errors
  end
...
function GutendexSDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = GutendexSDK.new(sdkopts)
  sdk.mode = "test"
