...
class GutendexRbacFeature extends GutendexBaseFeature
{
    ...
    private function _required(GutendexContext $ctx): ?string
    {
    ...
    private function _reject(GutendexContext $ctx, string $required): void
    {
    ...
    private function _track(GutendexContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
