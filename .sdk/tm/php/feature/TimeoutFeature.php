...
class GutendexTimeoutFeature extends GutendexBaseFeature
{
    ...
    private function _with_timeout(GutendexContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(GutendexContext $_ctx, float $ms): void
    {
        $client = $this->client;
