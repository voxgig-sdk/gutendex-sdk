...
// Gutendex SDK clienttrack feature
...
class GutendexClienttrackFeature extends GutendexBaseFeature
{
    ...
    public function PostConstruct(GutendexContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Gutendex-SDK';
