...
class GutendexNetsimFeature extends GutendexBaseFeature
{
    ...
    private function _simulate(GutendexContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(GutendexContext $ctx, array $applied): void
    {
        $client = $this->client;
