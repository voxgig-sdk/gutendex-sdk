...
// Gutendex SDK streaming feature
...
class GutendexStreamingFeature extends GutendexBaseFeature
{
    ...
    private function _iterate(GutendexResult $result): \Generator
    {
    ...
    private function _streamable(GutendexContext $ctx): bool
    {
