...
from projectname_sdk import GutendexSDK
from projectname_sdk.core.spec import GutendexSpec
from projectname_sdk.core.result import GutendexResult
from projectname_sdk.core.response import GutendexResponse
from projectname_sdk.core.operation import GutendexOperation
from projectname_sdk.core.error import GutendexError
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import GutendexBaseFeature
...
class TestPrimaryUtility:
    ...
    def test_feature_init_basic(self):
        init_client = GutendexSDK.test(None, None)
        ...
        class TestInitFeature(GutendexBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(GutendexBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = GutendexSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = GutendexSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = GutendexSDK.test(None, setup_opts)
