...
from projectname_sdk.core.control import GutendexControl
...
class GutendexContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(r, GutendexResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, GutendexResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return GutendexError(code, msg, self)
