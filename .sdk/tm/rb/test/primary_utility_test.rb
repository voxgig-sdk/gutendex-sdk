...
class PrimaryUtilityTest < Minitest::Test
  ...
  def setup
    @runner = GutendexOmni.make_runner(TEST_JSON_FILE, GutendexSDK.test(nil, nil))
  ...
  def test_make_point_basic
    ...
    subject = lambda do |ctx|
      ...
      err.nil? ? point : GutendexOmni.errify(err)
    end
