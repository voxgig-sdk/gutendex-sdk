...
|---|---|---|
| `ts/` | @voxgig-sdk/gutendex-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/gutendex-sdk \
      --repository voxgig-sdk/gutendex-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/gutendex-sdk` shows it, and
`npm trust revoke @voxgig-sdk/gutendex-sdk --id=<id>` removes it.
