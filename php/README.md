...
The PHP SDK for the Gutendex API — an entity-oriented client using PHP conventions.
...
```php
require_once 'gutendex_sdk.php';
$client = new GutendexSDK($options);
```
...
```
php/
├── gutendex_sdk.php          -- Main SDK class
...
The main class (`gutendex_sdk.php`) exports the SDK class
