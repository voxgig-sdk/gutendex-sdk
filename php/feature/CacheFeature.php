...
class GutendexCacheFeature extends GutendexBaseFeature
{
    ...
    private function _through(GutendexContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
