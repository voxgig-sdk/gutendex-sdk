...
class GutendexProxyFeature extends GutendexBaseFeature
{
    ...
    public function init(GutendexContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (GutendexContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
