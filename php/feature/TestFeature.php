...
// Gutendex SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class GutendexTestFeature extends GutendexBaseFeature
{
    ...
    public function init(GutendexContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (GutendexContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (GutendexContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(GutendexContext $ctx, $op, $args): array
    {
