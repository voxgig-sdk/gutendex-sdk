...
// Gutendex SDK ratelimit feature
...
class GutendexRatelimitFeature extends GutendexBaseFeature
{
    ...
    private function _acquire(GutendexContext $ctx): void
    {
    ...
    private function _track(GutendexContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
