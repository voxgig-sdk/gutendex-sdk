...
class GutendexFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; GutendexSDK/1.0)';
    ...
    public static function call(GutendexContext $ctx, string $fullurl, array $fetchdef): array
    {
