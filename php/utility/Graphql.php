...
class GutendexGraphql
{
    ...
    // equivalent.
    public static function body(GutendexContext $ctx): mixed
    {
    ...
    public static function errors(GutendexContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
