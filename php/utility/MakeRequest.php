...
// Gutendex SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class GutendexMakeRequest
{
    public static function call(GutendexContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new GutendexResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new GutendexResponse($fetched);
        } else {
