...
class GutendexTestRunner
{
    ...
    {
        $live = self::getenv('GUTENDEX_TEST_LIVE');
        $override = self::getenv('GUTENDEX_TEST_OVERRIDE');
        ...
        $explain = self::getenv('GUTENDEX_TEST_EXPLAIN');
...
class_alias('GutendexTestRunner', 'Runner');
class_alias('GutendexHelpers', 'Helpers');
