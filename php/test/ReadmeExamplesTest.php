...
// Gutendex SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (GutendexSDK::test)
...
{
    private const SDK_CLASS = 'GutendexSDK';
    ...
    private const SDK_BASE = 'gutendex_sdk';
