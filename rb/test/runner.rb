...
module GutendexTestRunner
  ...
  def self.env_override(m)
    live = getenv("GUTENDEX_TEST_LIVE")
    override = getenv("GUTENDEX_TEST_OVERRIDE")
    ...
    explain = getenv("GUTENDEX_TEST_EXPLAIN")
    m["GUTENDEX_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = GutendexTestRunner
Helpers = GutendexHelpers
Vs = VoxgigStruct
