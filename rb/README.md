...
The Ruby SDK for the Gutendex API — an entity-oriented client using idiomatic Ruby conventions.
...
- Releases: [https://github.com/voxgig-sdk/gutendex-sdk/releases](https://github.com/voxgig-sdk/gutendex-sdk/releases)
...
```ruby
client = GutendexSDK.test(testopts, sdkopts)
```
...
raise a `GutendexError` (a `StandardError` subclass), so wrap
...
```
rb/
├── Gutendex_sdk.rb       -- Main SDK module
...
The main module (`Gutendex_sdk`) exports the SDK class
